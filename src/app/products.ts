export const products = [
  {
    ...
    heading2: 'サンプルテキスト２',
    heading3: 'サンプルテキスト３',
    headingtext1: '欧州連合（ＥＵ）はブリュッセルで17日に開幕した首脳会議を延長し、新型コロナウイルスで打撃を被る国々を支援する「復興基金」について20日未明まで集中的に協議した。',
    headingtext2: '事情に詳しい複数の当局者によれば、実質的な復興基金となる総額7500億ユーロ（約92兆円）の経済再建策のうち、返済が必要ない補助金が占める割合を3900億ユーロとする最新案が夜を徹して協議された。',
  ...
  },
  {
    ...
    headingtext2: 'テキスト文章　テキスト文章　テキスト文章　テキスト文章　テキスト文章　テキスト文章　テキスト文章　',
